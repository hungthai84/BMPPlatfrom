...
import { 
  ...
  ChevronRight, ArrowUpRight, Plus, ExternalLink, RefreshCw, Maximize2
} from "lucide-react";
    ...
    <div className="space-y-6" id="process-map-tab">
      ...
      <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4" id="process-map-filters">
        <div className="flex items-center gap-2">
            <button
              onClick={() => {
                const elem = document.getElementById("process-map-tab");
              ...
              className="p-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-lg flex items-center gap-1.5 text-xs font-semibold"
              title="Phóng to quy trình"
            >
